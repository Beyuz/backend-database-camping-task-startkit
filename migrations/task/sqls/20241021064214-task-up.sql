...
(SELECT id FROM "USER" WHERE name = '王小明',SELECT id FROM CREDIT_PACKAGE WHERE name = '14堂組合包方案', SELECT credit_amount FROM "CREDIT_PACKAGE" WHERE name = '14堂組合包方案', SELECT price FROM "CREDIT_PACKAGE" WHERE name = '14堂組合包方案');
